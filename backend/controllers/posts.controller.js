...
export const createPost = async (req, res) => {
  ...
  try {
    ...
    //   userId: user._id,
    //   body: req.body.body,
    //   media: req.file ? req.file.filename : "", // Handle missing file
    //   fileType:
    //     req.file && req.file.mimetype
    //       ? req.file.mimetype.split("/")[0]
    //       : "unknown", // Handle missing or undefined mimetype
    // });

    // console.log(req.file); // Check if file is uploaded
    // if (req.file) {
    //   console.log(req.file.mimetype); // Check if mimetype exists
    // } else {
