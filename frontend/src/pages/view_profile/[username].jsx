...
const [isCurrentUserInConnect,setIsCurrentUserInConnect]=useState(false);
    ...
    <UserLayout>
      ...
      <div className={styles.profileContainer_details}>
        ...
        <div style={{flex:"0.8rem"}}>
          ...
          {isCurrentUserInConnect ? <button className={styles.connectedButton}>{
        ...
        {userPosts.map((post)=>{
          return(
            <div key={post._id} className={styles.postCard}>
              ...
              {post.media !==""?<img src={`${BASE_URL}/${post.media}`} alt="postImage"/>
              :
